            ...
            <div className="w-full h-full py-[40px] px-[70px] flex flex-col">
                ...
                <div className="w-full flex justify-center pt-[40px]">
                    <form 
                        ...
                        className="w-[50%] h-auto min-h-[200px] bg-[#222222] rounded-2xl 
                        border border-[#3a364c] flex flex-col p-6 gap-4">
                        <CustomInput 
                        label="Título"
                        value={titulo}
                        ...
                        <div className="w-full flex flex-col">
                            ...
                            <textarea 
                                ...
                                className="w-full h-[150px] min-h[150px] max-h[150px] rounded-lg 
                                bg-[#141414] border border-[#ffffff1a] outline-none pl-2 
                        ...
                        <CustomInput 
                            ...
                            <div className="w-full flex justify-end gap-4">
                               <button type="reset" className="w-[100px] h-[50px] rounded-md 
                                    bg-[#141414] cursor-pointer hover:bg-white/10
                                    border border-[#3a364c]">
                                    Cancelar
                                </button>
                                <button type="submit" className="w-[130px] h-[50px] rounded-md 
                                    bg-[#9245EBFF] cursor-pointer font-bold hover:bg-[#9A86F4]/80"> 
                                    Salvar Filme
                                </button>
                            </div>
                    </form>
